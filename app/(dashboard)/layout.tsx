...
const navItems = [
  ...
  { name: "Add Job", icon: PlusIcon, href: "/add-job", roles: ["admin", "employer"] },
  { name: "Jobs", icon: BriefcaseIcon, href: "/jobs", roles: ["admin", "employer", "student"] },
  {
  ...
  { name: "Saved Jobs", icon: BriefcaseIcon, href: "/saved-jobs", roles: ["admin", "student"] },
  { name: "Applied Jobs", icon: BookmarkIcon, href: "/applied-jobs", roles: ["admin", "student"] },
  {
    name: "Contact",
    icon: MapPinIcon,
    href: "/contact",
